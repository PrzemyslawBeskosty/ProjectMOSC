...
<html>
    ...
    <body>
        <table id="activeClients" class="display">
            <!-- Header for table -->
            <thead>
                <tr>
                    <th>Nazwa klienta</th>
            ...
            <!-- Data for table -->
            <tbody>
                <c:forEach var="tempClient" items="${activeClients}">
                    <!-- construct update link for clients -->
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            |
                            <a onclick="if (!(confirm('Czy chcesz usunąć wybranego klienta?'))) return false" 
